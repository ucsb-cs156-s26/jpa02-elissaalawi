...
public class DeveloperTest {
    ...
    public void getName_returns_correct_name() {
        ...
        assertEquals("Elissa", Developer.getName());
    }
    ...
    @Test
    public void getGithubId_returns_correct_githubIdd() {
        
        assertEquals("elissaalawi", Developer.getGithubId());
    }
    ...
    public void getTeam_returns_team_with_correct_members() {
        ...
        assertTrue(t.getMembers().contains("Ibrahim"),"Team shoud contain Ibrahim");
